...
public class ReactWheelCurvedPicker extends WheelCurvedPicker {
    ...
    private int delimeterColor = Color.WHITE;
    ...
    protected void drawForeground(Canvas canvas) {
        ...
        paint.setColor(delimeterColor);
        int colorFrom = delimeterColor;//Color.BLACK;
        int colorTo = delimeterColor;
    ...
    public void setDelimeterColor(int color) {
        delimeterColor = color;
    }
